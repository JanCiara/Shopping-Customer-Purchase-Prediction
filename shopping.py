...
def load_data(filename):
    ...
    # Mapping for month name to integer index
    month_map = {
...
def evaluate(labels, predictions):
    ...
    # Avoid division by zero if there are no actual positives or negatives
